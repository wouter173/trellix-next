...
export const Spinner = ({ className, ...props }: ComponentProps<'svg'>) => (
  ...
  >
    ...
    ></path>
    <path
      style={{ opacity: 0.6666666666666666 }}
      fill="currentColor"
      d="M9.133 7.937l-2.75-4.763a.999.999 0 111.732-1l2.75 4.765a1 1 0 01-1.732.998z"
    />
    <path style={{ opacity: 0.5833333333333334 }} fill="currentColor" d="M6.499 14.5H1a1 1 0 110-2.001h5.499a1.001 1.001 0 010 2.001z" />
    <path
      style={{ opacity: 0.5 }}
      fill="currentColor"
    ...
    ></path>
    <path
      style={{ opacity: 0.16666666666666666 }}
      fill="currentColor"
    ...
    ></path>
    <path
      style={{ opacity: 0.08333333333333333 }}
      fill="currentColor"
