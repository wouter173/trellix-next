        ...
        fallback={
          <>
            <div className="px-20 pb-4">
              <div className="h-8 w-64 animate-pulse rounded-xl bg-gray-100"></div>
            </div>
            <div className="flex gap-2 overflow-x-hidden px-20 pb-20">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex h-96 w-80 shrink-0 animate-pulse flex-col gap-2 rounded-xl bg-gray-100"></div>
              ))}
            </div>
          </>
        }
